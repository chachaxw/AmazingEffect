...
Elm.Transducer = Elm.Transducer || {};
Elm.Transducer.make = function (_elm) {
   "use strict";
   _elm.Transducer = _elm.Transducer || {};
   if (_elm.Transducer.values) return _elm.Transducer.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   var _op = {};
   var transduceSignal = F3(function (t,init,source) {
      return A2($Signal.map,$Basics.snd,A3($Signal.foldp,t.step($Basics.always),A2(t.init,$Basics.always,init),source));
   });
   var transduce = F5(function (fold,reduce,init,t,source) {    return A2(t.complete,reduce,A3(fold,t.step(reduce),A2(t.init,reduce,init),source));});
   var transduceList = A3(transduce,$List.foldr,F2(function (x,y) {    return A2($List._op["::"],x,y);}),_U.list([]));
   var transduceSet = A3(transduce,$Set.foldr,$Set.insert,$Set.empty);
   var transduceArray = A3(transduce,$Array.foldl,$Array.push,$Array.empty);
   var comp = F2(function (t1,t2) {
      return {init: F2(function (reduce,r) {
                return function (_p0) {
                   var _p1 = _p0;
                   return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: _p1._0,_1: _p1._1._0},_1: _p1._1._1};
                }(A2(t1.init,t2.step(reduce),A2(t2.init,reduce,r)));
             })
             ,step: F3(function (reduce,input,_p2) {
                var _p3 = _p2;
                return function (_p4) {
                   var _p5 = _p4;
                   return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: _p5._0,_1: _p5._1._0},_1: _p5._1._1};
                }(A3(t1.step,t2.step(reduce),input,{ctor: "_Tuple2",_0: _p3._0._0,_1: {ctor: "_Tuple2",_0: _p3._0._1,_1: _p3._1}}));
             })
             ,complete: F2(function (reduce,_p6) {
                var _p7 = _p6;
                return A2(t2.complete,reduce,A2(t1.complete,t2.step(reduce),{ctor: "_Tuple2",_0: _p7._0._0,_1: {ctor: "_Tuple2",_0: _p7._0._1,_1: _p7._1}}));
             })};
   });
   _op[">>>"] = comp;
   var partition = function (n) {
      return {init: F2(function (reduce,r) {    return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: n,_1: _U.list([])},_1: r};})
             ,step: F3(function (reduce,input,_p8) {
                var _p9 = _p8;
                var _p12 = _p9._1;
                var _p11 = _p9._0._0;
                var _p10 = _p9._0._1;
                return _U.cmp(_p11,0) > 0 ? {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: _p11 - 1,_1: A2($List._op["::"],input,_p10)},_1: _p12} : {ctor: "_Tuple2"
                                                                                                                                               ,_0: {ctor: "_Tuple2"
                                                                                                                                                    ,_0: n
                                                                                                                                                    ,_1: _U.list([input])}
                                                                                                                                               ,_1: A2(reduce,
             ...
             ,complete: F2(function (reduce,_p13) {    var _p14 = _p13;return A2(reduce,_p14._0._1,_p14._1);})};
   };
   var dedupe = {init: F2(function (reduce,r) {    return {ctor: "_Tuple2",_0: $Maybe.Nothing,_1: r};})
                ,step: F3(function (reduce,input,_p15) {
                   var _p16 = _p15;
                   var _p18 = _p16._0;
                   var _p17 = _p16._1;
                   return _U.eq($Maybe.Just(input),_p18) ? {ctor: "_Tuple2",_0: _p18,_1: _p17} : {ctor: "_Tuple2"
                                                                                                 ,_0: $Maybe.Just(input)
                                                                                                 ,_1: A2(reduce,input,_p17)};
                })
                ,complete: F2(function (reduce,_p19) {    var _p20 = _p19;return _p20._1;})};
   var drop = function (n) {
      return {init: F2(function (reduce,r) {    return {ctor: "_Tuple2",_0: n,_1: r};})
             ,step: F3(function (reduce,a,_p21) {
                var _p22 = _p21;
                var _p24 = _p22._1;
                var _p23 = _p22._0;
                return _U.cmp(_p23,0) > 0 ? {ctor: "_Tuple2",_0: _p23 - 1,_1: _p24} : {ctor: "_Tuple2",_0: 0,_1: A2(reduce,a,_p24)};
             })
             ,complete: F2(function (reduce,_p25) {    var _p26 = _p25;return _p26._1;})};
   };
   var take = function (n) {
      return {init: F2(function (reduce,r) {    return {ctor: "_Tuple2",_0: n,_1: r};})
             ,step: F3(function (reduce,input,_p27) {
                var _p28 = _p27;
                var _p30 = _p28._1;
                var _p29 = _p28._0;
                return _U.cmp(_p29,0) > 0 ? {ctor: "_Tuple2",_0: _p29 - 1,_1: A2(reduce,input,_p30)} : {ctor: "_Tuple2",_0: 0,_1: _p30};
             })
             ,complete: F2(function (reduce,_p31) {    var _p32 = _p31;return _p32._1;})};
   };
   var concatMap = function (f) {
      return {init: F2(function (reduce,r) {    return {ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: r};})
             ,step: F3(function (reduce,input,_p33) {
                var _p34 = _p33;
                return {ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: A3($List.foldl,reduce,_p34._1,f(input))};
             })
             ,complete: F2(function (reduce,_p35) {    var _p36 = _p35;return _p36._1;})};
   };
   var filter = function (f) {
      return {init: F2(function (reduce,r) {    return {ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: r};})
             ,step: F3(function (reduce,input,_p37) {
                var _p38 = _p37;
                var _p39 = _p38._1;
                return f(input) ? {ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: A2(reduce,input,_p39)} : {ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: _p39};
             })
             ,complete: F2(function (reduce,_p40) {    var _p41 = _p40;return _p41._1;})};
   };
   var map = function (f) {
      return {init: F2(function (reduce,r) {    return {ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: r};})
             ,step: F3(function (reduce,input,_p42) {    var _p43 = _p42;return {ctor: "_Tuple2",_0: {ctor: "_Tuple0"},_1: A2(reduce,f(input),_p43._1)};})
             ,complete: F2(function (reduce,_p44) {    var _p45 = _p44;return _p45._1;})};
   };
   var Transducer = F3(function (a,b,c) {    return {init: a,step: b,complete: c};});
   return _elm.Transducer.values = {_op: _op
                                   ...
                                   ,comp: comp
                                   ,transduce: transduce
                                   ,transduceList: transduceList
                                   ,transduceSet: transduceSet
                                   ,transduceArray: transduceArray
                                   ,transduceSignal: transduceSignal};
};
Elm.Native.Time = {};
...
Elm.Main.make = function (_elm) {
   ...
   $Transducer = Elm.Transducer.make(_elm),
   $Window = Elm.Window.make(_elm);
   var _op = {};
   var init = {particles: _U.list([]),seed: $Random.initialSeed(38),windowDimensions: {ctor: "_Tuple2",_0: 0,_1: 0}};
   var primaryColor = F2(function (hue,alpha) {    return A4($Color.hsla,$Basics.degrees(hue),0.6,0.7,alpha);});
   var view = function (state) {
      var renderParticle = function (particle) {
         return A2($Graphics$Collage.move,
         {ctor: "_Tuple2",_0: particle.x,_1: particle.y},
         A2($Graphics$Collage.scale,
         particle.scale,
         A2($Graphics$Collage.rotate,
         particle.rotate,
         A2($Graphics$Collage.filled,A2(primaryColor,particle.hue,particle.alpha),A2($Graphics$Collage.ngon,6,11)))));
      };
      var _p0 = state.windowDimensions;
      var w = _p0._0;
      var h = _p0._1;
      return A3($Graphics$Collage.collage,w,h,A2($List.map,renderParticle,state.particles));
   };
   var State = F3(function (a,b,c) {    return {particles: a,seed: b,windowDimensions: c};});
   var Particle = F8(function (a,b,c,d,e,f,g,h) {    return {x: a,y: b,hue: c,alpha: d,spin: e,rotate: f,scale: g,seed: h};});
   var CounterClockwise = {ctor: "CounterClockwise"};
   var Clockwise = {ctor: "Clockwise"};
   var makeParticle = F3(function (_p1,tick,seed) {
      var _p2 = _p1;
      var _p3 = A2($Random.generate,A2($Random.$float,-10,10),seed);
      var px = _p3._0;
      var seed0 = _p3._1;
      var _p4 = A2($Random.generate,A2($Random.$float,-10,10),seed0);
      var py = _p4._0;
      var seed1 = _p4._1;
      var _p5 = A2($Random.generate,A2($Random.$float,0.8,1),seed1);
      var alpha = _p5._0;
      var seed2 = _p5._1;
      var _p6 = A2($Random.generate,A2($Random.map,function (b) {    return b ? Clockwise : CounterClockwise;},$Random.bool),seed2);
      var spin = _p6._0;
      var seed3 = _p6._1;
      var _p7 = A2($Random.generate,A2($Random.$float,0,360),seed3);
      var rotate = _p7._0;
      var seed4 = _p7._1;
      var _p8 = A2($Random.generate,A2($Random.$float,0,1),seed4);
      var pseed = _p8._0;
      var seedLast = _p8._1;
      var particle = {x: px + _p2._0,y: py + _p2._1,hue: tick,alpha: alpha,spin: spin,rotate: rotate,scale: 1,seed: pseed};
      return {ctor: "_Tuple2",_0: particle,_1: seedLast};
   });
   var update = F2(function (_p9,state) {
      var _p10 = _p9;
      var _p19 = _p10._1._1;
      var _p18 = _p10._1._0;
      var _p17 = _p10._0._0;
      var _p16 = _p10._0._1;
      var adapt = function (particle) {
         return _U.update(particle,
         {y: particle.y + 3.25 + 10 * particle.seed
         ,alpha: (particle.alpha - 7.0e-2 * particle.seed) * 0.96
         ,rotate: function () {
            var _p11 = particle.spin;
            if (_p11.ctor === "Clockwise") {
                  return particle.rotate + particle.seed * 0.7;
               } else {
                  return particle.rotate - particle.seed * 0.7;
               }
         }()
      ...
      var isTransparentish = function (_p12) {    return A2(F2(function (x,y) {    return _U.cmp(x,y) < 1;}),3.5e-2,function (_) {    return _.alpha;}(_p12));};
      var updateParticles = $Transducer.transduceList(A2($Transducer._op[">>>"],$Transducer.filter(isTransparentish),$Transducer.map(adapt)));
      var _p13 = function () {
         var _p14 = {ctor: "_Tuple2",_0: _p18,_1: _p19};
         if (_p14.ctor === "_Tuple2" && _p14._0 === 0 && _p14._1 === 0) {
               return {ctor: "_Tuple2",_0: 0,_1: 0};
            } else {
               return {ctor: "_Tuple2",_0: $Basics.toFloat(_p18) - $Basics.toFloat(_p17) / 2,_1: $Basics.toFloat(_p16) / 2 - $Basics.toFloat(_p19)};
            }
      }();
      var dx = _p13._0;
      var dy = _p13._1;
      var _p15 = A3(makeParticle,{ctor: "_Tuple2",_0: dx,_1: dy},_p10._2,state.seed);
      var spawn = _p15._0;
      var seed = _p15._1;
      return _U.update(state,
      {particles: A2($List._op["::"],spawn,updateParticles(state.particles)),seed: seed,windowDimensions: {ctor: "_Tuple2",_0: _p17,_1: _p16}});
   });
   ...
   $Window.dimensions,
   $Mouse.position,
   A3($Signal.foldp,F2(function (_p20,t) {    return t + 1;}),0,$Time.fps(60)))));
